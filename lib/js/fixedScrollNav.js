...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"TOG4":[function(require,module,exports) {
...
},{}],"eB6j":[function(require,module,exports) {
"use strict";
...
function () {
  function FixedScrollNav() {
    _classCallCheck(this, FixedScrollNav);

    _smoothscrollPolyfill.default.polyfill(); //init polyfill
    //check if fixedScrollNav is needed in first place


    var isUsed = document.querySelector('.fixedScrollNav__container');
    ...
    var DiverentTools = DiverentTools || {};
    DiverentTools.fixedScrollNav = this; //set scope to window
  ...
  _createClass(FixedScrollNav, [{
    ...
    **/
    ...
    value: function _toggleButtons() {
      var activeSection_index = this.currentSection_index;
      var scrollPreviousButton = document.querySelector('.fixedScrollNav__button--previous');
      var scrollNextButton = document.querySelector('.fixedScrollNav__button--next');
      var sections = document.querySelectorAll("[data-fixedScrollNav-section]");
      sections = _toConsumableArray(sections); // scrollPreviousButton
      ...
      var amountOfSections = sections.length - 1;

      if (activeSection_index == amountOfSections || //last section is active
    ...
    key: "scrollToPreviousSection",
    value: function scrollToPreviousSection() {
      var activeSection_index = this.currentSection_index;

      if (activeSection_index !== -1) {
        var sections = document.querySelectorAll("[data-fixedScrollNav-section]");
        sections = _toConsumableArray(sections);
        var activeSection = sections[activeSection_index];
        var activeSectionTop = activeSection.getBoundingClientRect().top;
        ...
        if (activeSectionTop < -1) {
          ...
          var previousSection = sections[activeSection_index - 1]; //active section - 1 = previous section
    ...
    value: function scrollToNextSection() {
      var activeSection_index = this.currentSection_index;

      if (activeSection_index !== -1) {
        var sections = document.querySelectorAll("[data-fixedScrollNav-section]");
        sections = _toConsumableArray(sections);
        var nextSection = sections[activeSection_index + 1]; //active section + 1 = next section
    ...
    key: "_init__goToPreviousSection",
    value: function _init__goToPreviousSection() {
      var _this2 = this;
      ...
      scrollPreviousButton.addEventListener("click", function () {
        _this2.scrollToPreviousSection();
      });
      scrollPreviousButton.addEventListener('keypress', function (e) {
        if (e.key === 'Enter') {
          _this2.scrollToPreviousSection();
        }
      });
    ...
    **/
    ...
    key: "_init__goToNextSection",
    value: function _init__goToNextSection() {
      var _this3 = this;
      ...
      scrollNextButton.addEventListener("click", function () {
        _this3.scrollToNextSection();
      });
      scrollNextButton.addEventListener('keypress', function (e) {
        if (e.key === 'Enter') {
          _this3.scrollToNextSection();
        }
      });
    ...
    key: "currentSection_index",
    get: function get() {
      var sections = document.querySelectorAll("[data-fixedScrollNav-section]");

      var activeSection_index = _toConsumableArray(sections).findIndex(function (section) {
  ...
  return FixedScrollNav;
}(); //export module


var _default = FixedScrollNav;
exports.default = _default;
},{"smoothscroll-polyfill":"TOG4"}]},{},["eB6j"], null)